package net.leantechnology.elabina.useradmin.config.timezone;

import net.leantechnology.elabina.useradmin.ElabinaUserAdminApp;
import net.leantechnology.elabina.useradmin.repository.timezone.DateTimeWrapper;
import net.leantechnology.elabina.useradmin.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = ElabinaUserAdminApp.class)
